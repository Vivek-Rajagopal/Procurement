...
@javax.persistence.Table(name = "PA_Requestor_Details")
public class RequestorDetails extends 
org.drools.persistence.jpa.marshaller.VariableEntity  implements java.io.Serializable {

	static final long serialVersionUID = 1L;

	@javax.persistence.GeneratedValue(generator = "REQUESTORDETAILS_ID_GENERATOR", strategy = javax.persistence.GenerationType.AUTO)
	@javax.persistence.Id
	@javax.persistence.SequenceGenerator(name = "REQUESTORDETAILS_ID_GENERATOR", sequenceName = "REQUESTORDETAILS_ID_SEQ")
	...
	public RequestorDetails(java.lang.Long id, java.lang.String self_mail_id,
			java.lang.String self_bl_cd, java.lang.String self_dept_cd,
			java.lang.String self_cost_cd, java.lang.Boolean self_req,
			java.lang.String mail_id, java.lang.String bl_cd,
			java.lang.String dept_cd, java.lang.String cost_cd) {
		this.id = id;
		this.self_mail_id = self_mail_id;
		this.self_bl_cd = self_bl_cd;
		this.self_dept_cd = self_dept_cd;
